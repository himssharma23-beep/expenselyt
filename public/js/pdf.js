...
const _P = (() => {
  ...
  function header(doc, title, subtitle) {
    ...
    if (subtitle) {
      ...
      doc.text(String(subtitle), w - 14, 17.5, { align: 'right' });
    }
  ...
  function footer(doc) {
    ...
    for (let i = 1; i <= n; i++) {
      ...
      doc.text(`Generated by Expense Lite AI  ·  ${date}`, 14, h - 3);
  ...
  function cards(doc, y, items) {
    ...
    items.forEach((it, i) => {
      ...
      doc.text(String(it.label).toUpperCase(), x + 3, y + 5.5);
  ...
  return { init, W, H, header, footer, table, cards, section, note, save, cur, dt, MONTHS };
})();
