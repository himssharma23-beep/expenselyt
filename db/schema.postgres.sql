...
ALTER TABLE trips ADD COLUMN IF NOT EXISTS category TEXT;
ALTER TABLE trips ADD COLUMN IF NOT EXISTS transport_mode TEXT;
ALTER TABLE trips ADD COLUMN IF NOT EXISTS total_distance NUMERIC(14,2);
...
UPDATE trips SET destination = name WHERE destination IS NULL;
...
ALTER TABLE trip_expenses ADD COLUMN IF NOT EXISTS expense_type TEXT;
...
CREATE TABLE IF NOT EXISTS fixed_deposits (
  ...
  tenure_extra_months INTEGER NOT NULL DEFAULT 0,
